...
function cargarOrderDetail(){
    ...
    if(window.innerWidth >= 576){
        ...
        const todoMobil = document.getElementById('mobileS');
        const rowCard = document.createElement('div');
        rowCard.classList.add('row', 'd-flex', 'justify-content-center')
        console.log('Entro aca');
        const card = document.createElement('div');
        card.classList.add('card', 'boder', 'border-dark');
        card.style = 'background-color: rgb(196,196,196,.34); width:376px; margin-top: 10px';
        ...
        orderDetail.forEach(product=>{
            ...
            col1.innerText = product.amount;
            const col2 = document.createElement('div');
            col2.classList.add('col-6');
            col2.innerText = product.name;
            const col3 = document.createElement('div');
            col3.classList.add('col-4');
            col3.innerHTML = '<button style="background-color: #FDCD55;color:white;margin-right:10px;">+</button><button style="background-color: #FDCD55;color:white;">-</button>';
            row.appendChild(col1);
            row.appendChild(col2);
            row.appendChild(col3);
            containerr.appendChild(row);
        })
        cardBody.appendChild(containerr);
        card.appendChild(cardBody);
        rowCard.appendChild(card);
        todoMobil.appendChild(rowCard);
    }
